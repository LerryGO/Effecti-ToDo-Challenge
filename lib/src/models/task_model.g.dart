...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> cloudIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> cloudIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> cloudIdEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> cloudIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> cloudIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> cloudIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByCloudId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cloudId', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByCloudIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByCloudId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cloudId', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByCloudIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cloudId', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByCloudId() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, int?, QQueryOperations> cloudIdProperty() {
    return QueryBuilder.apply(this, (query) {
